...
# Add backend directory to path for prompts import
...
# Lazy initialization of retriever to avoid errors on import
RETRIEVER = None

def get_or_create_retriever():
    """Get the retriever, creating it if it doesn't exist."""
    global RETRIEVER
    if RETRIEVER is None:
        try:
            ...
            # Return None if initialization fails - the graph will handle this
            return None
    return RETRIEVER
